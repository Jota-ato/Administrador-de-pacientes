...
export default function PatientForm() {
    ...
    useEffect(() => {
        if (activeId) {
            ...
            const { name, caretaker, date, email, syntoms } = activePatient;
            setValue('name', name);
            setValue('caretaker', caretaker);
            setValue('date', date);
            setValue('email', email);
            setValue('syntoms', syntoms);
        } else {
            setValue('name', '');
            setValue('caretaker', '');
        ...
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            ...
            >
                ...
                <div className="mb-5">
                    ...
                    {errors.syntoms && (
                        <ErrorMessage>
                            {errors.syntoms?.message}
                        </ErrorMessage>)}
                </div>

                <input
                    type="submit"
                    className="bg-amber-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 cursor-pointer transition-colors"
